...
\makeatother
    ...
    \section{降雨数据初步清理}\label{ux964dux96e8ux6570ux636eux521dux6b65ux6e05ux7406}

    \subsubsection{2017-1-21日}\label{ux65e5}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}==================}
        \PY{c+c1}{\PYZsh{}       水数据修整}
        \PY{c+c1}{\PYZsh{}       FanMin}
        \PY{c+c1}{\PYZsh{}       Estabilish:20180101}
        \PY{c+c1}{\PYZsh{}       Last:20180119}
        \PY{c+c1}{\PYZsh{}==================}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{k+kp}{setwd}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{/Users/fanmin/Documents/GitHub/Water\PYZus{}Beijing\PYZdq{}}\PY{p}{)}
         filenames \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{list.files}\PY{p}{(}pattern \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{*.xlsx\PYZdq{}}\PY{p}{)}
         \PY{k+kr}{for}\PY{p}{(} fns \PY{k+kr}{in} filenames\PY{p}{)}\PY{p}{\PYZob{}}
                 dat \PY{o}{\PYZlt{}\PYZhy{}} read\PYZus{}excel\PY{p}{(}fns\PY{p}{)}
                 \PY{k+kp}{colnames}\PY{p}{(}dat\PY{p}{)} \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kt}{c}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{ID\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{Date\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{Water.Content.20m\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{Water.Content.40m\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{Water.Content.60m\PYZdq{}}\PY{p}{,}
                                    \PY{l+s}{\PYZdq{}}\PY{l+s}{Water.Content.80m\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{Water.Content.100m\PYZdq{}}\PY{p}{)}
                 dat\PY{o}{\PYZdl{}}Date \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{as.POSIXct}\PY{p}{(}\PY{k+kp}{strptime}\PY{p}{(}dat\PY{o}{\PYZdl{}}Date\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZpc{}m/\PYZpc{}d/\PYZpc{}y \PYZpc{}H:\PYZpc{}M:\PYZpc{}S\PYZdq{}}\PY{p}{)}\PY{p}{)}
                 dat\PY{o}{\PYZdl{}}Water.Content.20m \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{as.numeric}\PY{p}{(}dat\PY{o}{\PYZdl{}}Water.Content.20m\PY{p}{)}
                 dat\PY{o}{\PYZdl{}}Water.Content.40m \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{as.numeric}\PY{p}{(}dat\PY{o}{\PYZdl{}}Water.Content.40m\PY{p}{)}
                 dat\PY{o}{\PYZdl{}}Water.Content.60m \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{as.numeric}\PY{p}{(}dat\PY{o}{\PYZdl{}}Water.Content.60m\PY{p}{)}
                 dat\PY{o}{\PYZdl{}}Water.Content.80m \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{as.numeric}\PY{p}{(}dat\PY{o}{\PYZdl{}}Water.Content.80m\PY{p}{)}
                 dat\PY{o}{\PYZdl{}}Water.Content.100m \PY{o}{\PYZlt{}\PYZhy{}} \PY{k+kp}{as.numeric}\PY{p}{(}dat\PY{o}{\PYZdl{}}Water.Content.100m\PY{p}{)}
                 \PY{k+kp}{print}\PY{p}{(}\PY{k+kp}{paste}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{以下是\PYZdq{}}\PY{p}{,}\PY{k+kp}{substr}\PY{p}{(}fns\PY{p}{,}\PY{l+m}{1}\PY{p}{,}\PY{l+m}{4}\PY{p}{)}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{年数据的基本情况\PYZdq{}}\PY{p}{,}sep\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{)}
                 \PY{k+kp}{print}\PY{p}{(}\PY{k+kp}{summary}\PY{p}{(}dat\PY{p}{)}\PY{p}{)}
                 \PY{k+kp}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
                 dat \PY{o}{\PYZlt{}\PYZhy{}} melt\PY{p}{(}dat\PY{p}{,}id.vars\PY{o}{=}\PY{k+kt}{c}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Date\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{ID\PYZdq{}}\PY{p}{)}\PY{p}{)}
                 myplot \PY{o}{\PYZlt{}\PYZhy{}} ggplot\PY{p}{(}dat\PY{p}{,}aes\PY{p}{(}x\PY{o}{=}Date\PY{p}{,}y\PY{o}{=}value\PY{p}{,}group\PY{o}{=}variable\PY{p}{,}col\PY{o}{=}variable\PY{p}{)}\PY{p}{)}\PY{o}{+}
                         geom\PYZus{}line\PY{p}{(}\PY{p}{)}\PY{o}{+}
                         facet\PYZus{}grid\PY{p}{(}ID\PY{o}{\PYZti{}}\PY{l+m}{.}\PY{p}{,}scales\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{free\PYZus{}y\PYZdq{}}\PY{p}{)}\PY{o}{+}
                         ggtitle\PY{p}{(}\PY{k+kp}{paste}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Water contenct in the earth in \PYZdq{}}\PY{p}{,}\PY{p}{(}\PY{k+kp}{gsub}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{.xlsx\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{,}fns\PY{p}{)}\PY{p}{)}\PY{p}{,}sep\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{)}\PY{p}{)}\PY{o}{+}
                         theme\PY{p}{(}plot.title \PY{o}{=} element\PYZus{}text\PY{p}{(}hjust \PY{o}{=} \PY{l+m}{0.5}\PY{p}{)}\PY{p}{)}
                 \PY{k+kp}{print}\PY{p}{(}myplot\PY{p}{)}
                 \PY{k+kp}{cat}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZbs{}n\PYZdq{}}\PY{p}{)}
         \PY{p}{\PYZcb{}}
\end{Verbatim}
